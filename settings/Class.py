...
class Ui_MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setUp()
    def setUp(self):
        #获取初始化的相关信息，设置好combobox中的内容以及表格中的内容
        self.setGrade()
        self.query()
    ...
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(10, 210, 61, 31))
        self.label.setObjectName("label")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(70, 210, 121, 31))
        self.lineEdit.setObjectName("lineEdit")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(210, 210, 61, 31))
        self.label_2.setObjectName("label_2")
        self.lineEdit_2 = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_2.setGeometry(QtCore.QRect(270, 210, 121, 31))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(80, 260, 71, 31))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(160, 260, 71, 31))
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_3 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_3.setGeometry(QtCore.QRect(240, 260, 71, 31))
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_4 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_4.setGeometry(QtCore.QRect(320, 260, 71, 31))
        self.pushButton_4.setObjectName("pushButton_4")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(10, 170, 61, 31))
        self.label_3.setObjectName("label_3")
        self.comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox.setGeometry(QtCore.QRect(70, 170, 71, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "所属年级"))
    ...
    def query(self):
        ...
        result = service.query2("select * from tb_class")
        row = len(result)
        for i in range(row):
            self.tableWidget.insertRow(i)
            for j in range(len(result[0])):
                if j == 1:
                    gradeName = service.query("select gradeName from tb_grade where gradeId = %s",(str(result[i][j]),))[0][0]
                    data = QTableWidgetItem(gradeName)
                else:
    ...
    def getClassName(self,name):
        result = service.query("select gradeName from tb_grade where gradeName = %s",(name))
        return len(result)
    ...
    def add(self):
        ...
        if classID != "" and className != "":
            if self.getClassName(className) > 0:
                QMessageBox.information(None,'提示','已经存在',QMessageBox.Ok)
            else:
                gradeID = service.query("select gradeID from tb_grade where gradeName = %s",(self.comboBox.currentText(),))[0][0]
    ...
    def edit(self):
        ...
        if classID != "" and className != "":
            if self.getClassName(className) > 0:
                ...
                gradeID = service.query("select gradeID from tb_grade where gradeName = %s", (self.comboBox.currentText(),))[0][0]
                result = service.exec("update tb_class set classID = %s,gradeID = %s,className = %s where classID = %s",
                                      (classID, gradeID, className, classID))
                if result > 0:
